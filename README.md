...
* **Excaliraw 版本更新：V0.17.0——&gt;V0.18.0 ，** 具体更新内容可参考：[https://github.com/excalidraw/excalidraw/releases](https://github.com/excalidraw/excalidraw/releases)
  ...
  * 其他感觉比较好用的更新点：
    ...
    * 默认支持手写字体。字体文件在`Whiteboard/fonts/Xiaolai`文件夹下，被拆分成多个woff2文件以便懒加载。虽然字体文件略大，但是字形看着不错，兼顾了可读性和美观。
...
对于版本V2.0.0，打开挂件文件夹`Whiteboard`——`assets`——`index-CkG_Q7os.js`,在该js文件中搜索：
